...
* **Protected Execution (`POST /mcp`)**: Authenticated JSON-RPC 2.0 interface exposing **74 tools** across workflow design, context-aware simulation, context bindings, Copilot synthesis, time-travel replay, state machine verification, execution, human tasks, notifications, and advisory agents.
