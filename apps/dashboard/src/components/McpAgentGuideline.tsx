      ...
      {activeTab === 'browser' && (
        <div className="bg-slate-900/80 rounded-xl p-4 border border-slate-800 text-xs">
          ...
          <ol className="list-decimal list-inside space-y-2 text-slate-300 leading-relaxed">
            ...
            <li>
              <strong>Plan entitlement:</strong> MCP is included on every package. Free / Trial keys return <code className="text-amber-300 bg-slate-800 px-1 rounded">MCP-PLAN-REQUIRED</code> (HTTP 402) for runtime tools such as <code className="text-blue-300">start_workflow</code>, <code className="text-blue-300">publish_event</code>, and <code className="text-blue-300">complete_task</code>.
            </li>
            <li>
